<x-app-layout>
    ...
    <script src="https://cdn.tiny.cloud/1/wio5bmyz5jvxaul0xwo6ma6oyonst3bi6fplz0lk4od0h8wc/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
      <script>tinymce.init({ selector:'#content-area' });</script>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3 class="mb-3">Edit Posts</h3>
                    <ul class="px-6">
                    @foreach($posts as $post)
                        
                        <li class="list-disc" ><a href="posts/edit/{{ $post->id }}" class=" text-blue-500">{{ $post->title }}</a></li>
